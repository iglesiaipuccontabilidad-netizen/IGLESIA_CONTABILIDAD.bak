    ...
    <main className="min-h-screen bg-gradient-to-br from-violet-50 via-fuchsia-50 to-pink-50 px-4 py-8 relative overflow-hidden">
      ...
      <div className="container max-w-4xl mx-auto relative z-10">
        <div className="bg-white rounded-2xl shadow-xl border border-primary-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-primary-700 via-primary-600 to-primary-500 px-8 py-6 relative overflow-hidden">
            {/* Patrón decorativo */}
            ...
            <div className="flex items-center justify-between relative z-10">
              <div>
                ...
                <p className="text-primary-100 text-sm mt-1">Registra un nuevo compromiso financiero</p>
              </div>
