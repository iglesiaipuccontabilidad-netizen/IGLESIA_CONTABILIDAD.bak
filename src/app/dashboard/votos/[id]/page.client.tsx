...
interface VotoDetailClientProps {
  voto: VotoConDetalles
}

export default function VotoDetailClient({ voto }: VotoDetailClientProps) {
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true)
    try {
      const result = await deleteVoto(voto.id)

      if (result.success) {
        toast.success('Voto eliminado exitosamente', {
          description: 'El voto y todos sus pagos asociados han sido eliminados.'
        })
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900">Eliminar voto</h3>
            ...
            <div className="mb-6">
              <p className="text-gray-700 mb-3">
                ¿Estás seguro de que quieres eliminar este voto?
              </p>
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="text-sm text-red-800">
                  <strong>Se eliminará permanentemente:</strong>
                  <ul className="mt-2 ml-4 list-disc space-y-1">
                    <li>El voto de {voto.miembro.nombres} {voto.miembro.apellidos}</li>
                    <li>Todos los pagos registrados ({totalPagos} pago{totalPagos !== 1 ? 's' : ''})</li>
