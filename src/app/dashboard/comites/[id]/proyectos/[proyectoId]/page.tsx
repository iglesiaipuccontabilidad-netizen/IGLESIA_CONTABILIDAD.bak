      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between mb-2">
            <p className="text-purple-100 text-sm font-medium">Recaudado</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          <div className="flex items-center justify-between mb-2">
            <p className="text-slate-600 text-sm font-medium">Total Votos</p>
            <Vote className="w-5 h-5 text-primary-500" />
          </div>
          <p className="text-3xl font-bold text-slate-900">{totalVotos}</p>
          <p className="text-slate-500 text-sm mt-1">{votosActivos} activos</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          ...
          <p className="text-3xl font-bold text-slate-900">
            ${montoTotalPagado.toLocaleString('es-CO')}
          </p>
          <p className="text-slate-500 text-sm mt-1">de los votos</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200">
        <div className="p-6 border-b border-slate-200">
          ...
          <p className="text-sm text-slate-600 mt-1">
            Votos que contribuyen a este proyecto
          </p>
        </div>
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-slate-200">
                {votos.map((voto) => {
                  ...
                  const usuario = voto.usuarios as any
